...
var _1 = require("./");
var PlayerFinderAccountModule = /** @class */ (function () {
    function PlayerFinderAccountModule() {
    }
    PlayerFinderAccountModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return PlayerFinderAccountModule;
}());
exports.PlayerFinderAccountModule = PlayerFinderAccountModule;
