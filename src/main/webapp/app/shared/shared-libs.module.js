...
var PlayerFinderSharedLibsModule = /** @class */ (function () {
    function PlayerFinderSharedLibsModule() {
    }
    PlayerFinderSharedLibsModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return PlayerFinderSharedLibsModule;
}());
exports.PlayerFinderSharedLibsModule = PlayerFinderSharedLibsModule;
