...
var _1 = require("./");
var PlayerFinderAdminModule = /** @class */ (function () {
    function PlayerFinderAdminModule() {
    }
    PlayerFinderAdminModule = __decorate([
        core_1.NgModule({
            imports: [
    ...
    return PlayerFinderAdminModule;
}());
exports.PlayerFinderAdminModule = PlayerFinderAdminModule;
