...
import feup.les.teamc.app.config.audit.AuditEventConverter;
import feup.les.teamc.app.domain.PersistentAuditEvent;
...
import static feup.les.teamc.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
